...
_SCALAR_MAP = {
    ...
    ('timeouts', 'budget_total'): 'TIME_BUDGET_TOTAL',
    ...
    ('left_flow', 'hook_yaw_kp'):      'LEFT_HOOK_YAW_KP',
    ('left_flow', 'hook_max_yaw'):     'LEFT_HOOK_MAX_YAW',
    ...
    ('left_flow', 'visual_max_surge'): 'LEFT_VISUAL_MAX_SURGE',
    ('left_flow', 'visual_max_sway'):  'LEFT_VISUAL_MAX_SWAY',
    ('left_flow', 'visual_max_yaw'):   'LEFT_VISUAL_MAX_YAW',
    ('left_flow', 'visual_max_vert'):  'LEFT_VISUAL_MAX_VERT',
    ('left_flow', 'visual_slew'):      'LEFT_VISUAL_SLEW',
