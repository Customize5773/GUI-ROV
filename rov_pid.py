...
PID_PARAM_MAP = {
    ...
    # ATC_ANG_RLL_P/PIT_P (loop attitude, di atas ATC_RAT_*) — ditambahkan 23 Agu
    # 2026 utk redam tilt ±8-13° saat stik penuh (ATC_RAT/ATC_ANG kalah otoritas
    # thruster). Panel Setup GUI mengirim field ini (setup.js:19,23) — jangan
    # dihapus, atau kedua input itu diam-diam diabaikan.
